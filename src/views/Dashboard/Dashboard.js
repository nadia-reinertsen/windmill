...
export default function Dashboard() {
  ...
  const windSpeedData = {
    labels: ["10 hours ago ", " 9 hours ago ", " 8 hours ago ", "7 hours ago","6 hours ago","5 hours ago","4 hours ago","3 hours ago", "2 hours ago","1 hour ago"],
        ...
        <Card>
          <CardHeader color="danger" stats icon>
            ...
            <p className={classes.cardCategory}>
              Total earnings from current active windmills
            </p>
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="info" stats icon>
              ...
              <h3 className={classes.cardTitle}>{activeSum}<small> Active</small></h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
                <Update />
      ...
      <GridContainer>
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            ...
            <CardBody>
              <h4 className={classes.cardTitle}>Daily windspeed overview </h4>
              <p className={classes.cardCategory}>
            ...
            <CardFooter chart>
              <div className={classes.stats}>
                <AccessTime /> Updated 1 minuite ago
              </div>
            </CardFooter>
          </Card>
        </GridItem>
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            ...
            <CardBody>
              <h4 className={classes.cardTitle}>Daily Avg. Earnings</h4>
              <p className={classes.cardCategory}>
        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            ...
            <CardBody>
              <h4 className={classes.cardTitle}>Daily Avg. Active windmills</h4>
